...
// load the styles
var content = __webpack_require__("63e9");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("7f2c023a", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./src/index.vue?vue&type=template&id=7f50549b&
...
/* harmony default export */ var lib_vue_loader_options_srcvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    centralP: function centralP() {
      return this.circleSize / 2;
    }
  },
  methods: {
    increaseNumber: function increaseNumber(number, className) {
      var _this = this;
      ...
      var innerNum = parseInt(this.findClosestNumber(this.transitionDuration / 10, number));
      var interval = this.transitionDuration / innerNum;
      var counter = 0;
      var handlerName = "".concat(className, "Interval");
      this[handlerName] = setInterval(function () {
        var bitDiff = number.toString().length - innerNum.toString().length;

        if (bitDiff == 0) {
          _this[className] = counter;
        } else {
          _this[className] = counter * 10 * bitDiff;
        }

        if (counter === innerNum) {
          // back to origin precision
          _this[className] = number;
          window.clearInterval(_this[handlerName]);
        }

        counter++;
      }, interval);
    },
    findClosestNumber: function findClosestNumber(bound, value) {
      if (value <= bound) {
        return value;
      }
    ...
    countNumber: function countNumber(v) {
      var _this2 = this;

      this.offset = "";
      this.initTimeoutHandler = setTimeout(function () {
        _this2.offset = _this2.circumference * (100 - v) / 100;
      }, 100);
      if (this.$slots.default) return;

      var _v$toString$split = v.toString().split("."),
          _v$toString$split2 = _slicedToArray(_v$toString$split, 2),
          int = _v$toString$split2[0],
          dec = _v$toString$split2[1]; // fallback for NaN
...
/* harmony default export */ var src_0 = (src);
...
/******/ });
//# sourceMappingURL=easy-circular-progress.common.js.map